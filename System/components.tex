...
\begin{enumerate}
	...
	\colorbox{lightgray}{\lstinline{nuser(xxxx)@example.com\\nbcc:maluser(xxxx)@example.com}} - This is the most minimal payload, it injects a `newline' character followed by the \texttt{bcc} field.
	\item \colorbox{lightgray}{\lstinline{nuser(xxxx)@example.com\\r\\nbcc:maluser(xxxx)@example.com}} - This payload is added for purposes of cross-platform fuzzing: \texttt{\textbackslash{}r\textbackslash{}n} is the `Carriage Return - New Line (CRLF)' used on Windows systems. 
